...
Los datos y el código fuente utilizados en este estudio están disponibles públicamente en el siguiente repositorio de GitHub:\\

\url{https://github.com/YonhelMamaniCruz/M_optimizacion/tree/main/actividad4_unidad2}\\21




El conjunto de datos original fue obtenido de Kaggle y puede consultarse en:\\
